	...
	<div>
		...
		<div
			...
			<div class="bg-white p-4 rounded shadow mt-5"
				...
				<h2 class="text-center text-primary mb-4">Transfer Money</h2>
				<form action="transferMoney" method="post">
					<div class="mb-3">
						<label for="id" class="form-label">Enter Receiver Account Number</label> <input
							type="number" class="form-control" id="id" name="receiverAccountNumber"
