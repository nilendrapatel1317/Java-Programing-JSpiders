...
@WebServlet("/debitMoney")
public class DebitMoneyServlet extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int debitResult = BankingServices.debitMoney(account, amount);
		switch (debitResult) {
			case 1:
				// Success
			...
			case -1:
				...
				rd = req.getRequestDispatcher("debitMoneyPage.jsp");
				rd.include(req, resp);
				break;
